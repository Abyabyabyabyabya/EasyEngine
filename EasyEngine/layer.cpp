...
******************************************************************************/
layer_ns::Layer::Layer(const UINT Width, const UINT Height, const UINT SCount, const UINT SQuality, const Layer::Format TexFormat) :
    Texture{} {
    // テクスチャを作成
    ...
    tex_desc.Format = kFormatMap[t_lib::enumValue(TexFormat)];
